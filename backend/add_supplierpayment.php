    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Add Supplier Payment Data</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
      ...
      <section class="content">
        <div class="card card-primary">
          <div class="card-header">
            <h3 class="card-title">Form Tambah Data Supplier Payment</h3>
          </div>
          <!-- /.card-header -->
          <!-- form start -->
          <form>
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  ...
                  <div class="form-group">
                    <label>Nama Suppplier</label>
                    <select class="form-control">
                      <option>Suppplier 1</option>
                      <option>Suppplier 2</option>
                      <option>Suppplier 3</option>
                    </select>
                  </div>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="masukkan jumlah pembayaran">
              </div>
              <div class="form-group">
              ...
              <div class="col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <div class="form-check">
                    ...
                    <label class="form-check-label">Hanya Uang Muka</label>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" checked="">
              ...
              <div class="form-group">
                ...
                <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Masukkan Grade Barang">
              </div>
              <div class="form-group">
