        ...
        <div class="modal-body">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" id="namaKapal" name="namaKapal" placeholder="masukkan Nomor Telefon">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Status Pembayaran</label>
              <input type="text" class="form-control" id="nomorKapal" name="nomorKapal" placeholder="masukkan Nomor Rekening">
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
          <button type="submit" id='submitKapal' name='submitKapal' class="btn btn-primary">Tambahkan Data</button>
        </div>
      </form>
    </div>
  </div>
                          ...
                          <tbody>
                            <?php foreach ($data as $row) : ?>
                              <tr role="row" class="even">
                                <td class="dtr-control sorting_1" tabindex="0"><?= $row['nama_kapal'] ?></td>
                                <td>
                                  <?= $row['no_kapal'] ?>
                                </td>
                                <td>
                                  ...
                                  <div class="modal-content">
                                    <form method="POST">
                                      ...
                                      <div class="card-body">
                                        <?php
                                          $id = $row["id"];
                                          $datas = query("SELECT * FROM kapal WHERE id=$id");
                                        ?>
                                        <?php foreach ($datas as $rows) : ?>
                                          ...
                                          <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="namaKapal" name="namaKapal" value="<?= $row['nama_kapal'] ?>">
                                          </div>
                                          <div class="form-group">
                                            <label for="exampleInputEmail1"> <?= $row['no_kapal'] ?></label>
                                            <input type="text" class="form-control" id="nomorKapal" name="nomorKapal" value="<?= $row['no_kapal'] ?>">
                                          </div>
                                        <?php endforeach; ?>
                                      </div>
