    ...
    <div class="modal-content">
      <form method="POST">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLongTitle">Tambah Data Stock</h5>
        ...
        <div class="modal-body">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="container" name="container" placeholder="masukkan Nomor container">
            </div>
            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">Nomor Truk</label>
              <input type="text" class="form-control" id="truck" name="truck" placeholder="masukkan Nomor Truk">
            </div>
            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">Nomor Seal</label>
              <input type="text" class="form-control" id="nomor_seal" name="nomor_seal" placeholder="masukkan Nomor Seal">
            </div>
          </div>
          <div class="form-group">
          ...
          <div class="form-row">
            <div class="form-group col-md-4">
              ...
              <input type="text" class="form-control" id="jenis_barang" name="jenis_barang" placeholder="masukkan Nama Barang">
            </div>
            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">Grade Barang</label>
              <input type="text" class="form-control" id="grade_barang" name="grade_barang" placeholder="masukkan Nama Barang">
            </div>
            <div class="form-group col-md-4">
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="asal_barang" name="asal_barang" placeholder="masukkan Nama Barang">
          </div>

          <div class="form-row">
            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">Coly</label>
              <input type="text" class="form-control" id="coly" name="coly" placeholder="masukkan Jumlah Coly">
            </div>
            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">Gross</label>
              <input type="text" class="form-control" id="gross" name="gross" placeholder="masukkan Jumlah Gross">
            </div>
            <div class="form-group col-md-4">
              <label for="exampleInputEmail1">Netto</label>
              <input type="text" class="form-control" id="netto" name="netto" placeholder="masukkan Jumlah Netto">
            </div>
          </div>
        </div>
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Keluar</button>
          <button type="submit" id='submitStockin' name='submitStockin' class="btn btn-primary">Tambahkan Data</button>
        </div>
      </form>
    </div>
  </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                          <thead>
                            <tr role="row">
                              ...
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Browser: activate to sort column ascending">Container</th>
                              ...
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">jenis barang</th>
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">grade barang</th>
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">truck</th>
                              ...
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">asal barang</th>
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">coly</th>
                              ...
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Engine version: activate to sort column ascending">netto</th>
                            ...
                            <form method="POST">
                              <?php foreach ($data as $row) : ?>
                                <tr role="row" class="even">
                                  ...
                                  <td><?= $row["grade_barang"] ?></td>
                                  <td><?= $row["truck"] ?></td>
                                  <td><?= $row["nomor_seal"] ?></td>
                                ...
                                <div class="modal fade bd-example-modal-lg-edit<?= $row["id"] ?>" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
                                  <div class="modal-dialog modal-lg">
                                    <div class="modal-content">
                                      <form method="POST">
                                        <div class="modal-header">
                                          <h5 class="modal-title" id="exampleModalLongTitle">Edit Data Stockin</h5>
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            <span aria-hidden="true">&times;</span>
                                          </button>
                                        </div>
                                        <div class="card-body">
                                          ...
                                          <?php foreach ($datas as $rows) : ?>
                                            ...
                                            <div class="form-row">
                                              <div class="form-group col-md-4">
                                                <label for="exampleInputEmail1">Nomor Kontainer</label>
                                                <input type="text" class="form-control" id="container" name="container" value="<?= $row['container'] ?>">
                                              </div>
                                              <div class="form-group col-md-4">
                                                <label for="exampleInputEmail1">Nomor Truk</label>
                                                <input type="text" class="form-control" id="truck" name="truck" placeholder="masukkan Nomor Truk" value="<?= $row['truck'] ?>">
                                              </div>
                                              <div class="form-group col-md-4">
                                                <label for="exampleInputEmail1">Nomor Seal</label>
                                                <input type="text" class="form-control" id="nomor_seal" name="nomor_seal" placeholder="masukkan Nomor Seal" value="<?= $row['nomor_seal'] ?>">
                                              </div>
                                            </div>
                                            <div class="form-group">
                                              <label for="exampleInputEmail1">Nama Barang</label>
                                            ...
                                            <div class="form-row">
                                              <div class="form-group col-md-4">
                                                <label for="exampleInputEmail1">Jenis Barang</label>
                                                <input type="text" class="form-control" id="jenis_barang" name="jenis_barang" placeholder="masukkan Nama Barang" value="<?= $row['jenis_barang'] ?>">
                                              </div>
                                              <div class="form-group col-md-4">
                                                <label for="exampleInputEmail1">Grade Barang</label>
