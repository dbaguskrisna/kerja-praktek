        ...
        <div class="modal-body">
          <div class="card-body">
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="namaSupplier" id="namaSupplier" placeholder="masukkan Nama Supplier">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              ...
              <input type="text" class="form-control" name="noTelp" id="noTelp" placeholder="masukkan Nomor Telefon">
            </div>
          </div>
        </div>
      ...
      <div class="modal-body">
        <form>
          <div class="card-body">
            <div class="form-group">
              <label for="exampleInputEmail1">Nama Supplier</label>
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="masukkan Nama Supplier">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Nama Kontainer</label>
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="masukkan Alamat Supplier">
            </div>
            <div class="form-group">
              <label for="exampleInputEmail1">Nomor Telefon</label>
              <input type="text" class="form-control" id="exampleInputEmail1" placeholder="masukkan Nomor Telefon">
            </div>
                        ...
                        <table id="example2" class="table table-bordered table-hover dataTable dtr-inline" role="grid" aria-describedby="example2_info">
                          <thead>
                            <tr role="row">
                              ...
                              <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1" aria-label="Platform(s): activate to sort column ascending">Nomor Handphone</th>
                            </tr>
                          </thead>
                          <tbody>
                            <form method="POST">
                              <?php foreach ($data as $row) : ?>
                                <tr role="row" class="even">
                                  <td class="dtr-control sorting_1" tabindex="0"><?= $row["nama_supplier"] ?></td>
                                  <td><?= $row["alamat"] ?>
                                  </td>
                                  <td><?= $row["no_hp"] ?></td>
                                  <td>
                                    ...
                                    <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#exampleModal<?= $row["id_supplier"] ?>">
                                      Hapus data
                                    </button>
                                  </td>
                                </tr>
                                        ...
                                        <?php foreach ($datas as $rows) : ?>
                                          <div class="card-body">
                                            <div class="form-group">
                                              ...
                                              <input type="text" class="form-control" id="idSupplier" name="idSupplier" value="<?= $rows['id_supplier'] ?>" readonly="true">
                                            </div>
                                            <div class="form-group">
                                              <label for="exampleInputEmail1">Nama Supplier</label>
                                              <input type="text" class="form-control" id="namaUpdate" name="namaUpdate" value="<?= $rows['nama_supplier'] ?>">
                                            </div>
                                            <div class="form-group">
                                              <label for="exampleInputEmail1">Alamat</label>
                                              <input type="text" class="form-control" id="alamatUpdate" name="alamatUpdate" value="<?= $rows['alamat'] ?>">
                                            </div>
                                            <div class="form-group">
                                              <label for="exampleInputEmail1">No HP</label>
                                              <input type="text" class="form-control" id="noHp" name="noHp" value="<?= $rows['no_hp'] ?>">
                                            </div>
                                          </div>
                                        <?php endforeach; ?>
                                        <!-- /.card-body -->
                                ...
                                <div class="modal fade" id="exampleModal<?= $row["id_supplier"] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                  <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body">
                                        ...
                                        <?php foreach ($datas as $rows) : ?>
                                          <div class="card-body" hidden>
                                            ...
                                            <div class="form-group">
                                              <label for="exampleInputEmail1">Nama Supplier</label>
                                              <input type="text" class="form-control" id="namaUpdate" name="namaUpdate" value="<?= $rows['nama_supplier'] ?>" readonly="true">
                                            </div>
                                          </div>
                                        <?php endforeach; ?>
                                      </div>
                                      <div class="modal-footer">
                                        ...
                                        <button type="submit" id="submitDelete" name="submitDelete" class="btn btn-primary">Delete data</button>
                                      </div>
                                    </div>
                                  </div>
                                </div>
